...
<!-- Mirrored from wowtheme7.com/tf/dyat/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2024 15:49:08 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <nav class="navbar navbar-area navbar-area-2 navbar-border navbar-expand-lg">
        <div class="container nav-container px-lg-0">
                ...
                <!-- <ul class="navbar-nav menu-open ps-lg-5 pe-xl-4 text-end">
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="explore-product.html">Explore product</a></li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="create-item.html">Create Items</a></li>
            ...
            <div class="nav-right-part nav-right-part-desktop d-lg-inline-flex align-item-center">
                <!-- <div class="header-search search-bar-btn  d-inline-block me-3">
                    <button>
                ...
                <div class="col-lg-6 pe-xl-5">
                    <div class="pe-xl-5 pe-lg-4">
                        ...
                        <form class="login-form-inner" method="POST" action="register">
                            ...
                            <button class="btn btn-base tt-uppercase w-100" type="submit">Register</button>
    ...
    <!-- footer area start -->
    <footer class="footer-area footer-area-1 pd-top-110 mt--35" style="background-image: url('assets/img/footer/bg.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget_about">
                        ...
                        <div class="details">
                            ...
                            <h5>Open Hours</h5>
                            <p><strong>Sunday to Friday <span class="color-base">08:00-20:00</span></strong></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget_subscribe">
                        ...
                        <p class="mb-3">Sedsit amet nisl inveli viverra bendum acnisi. Etiam efficitur.</p>
                        <form action="#">
                            <div class="single-input-inner">
                                <input type="text" placeholder="info@yourmail.com">
                            </div>
                            <div class="btn-box d-inline-block">
                                <button type="submit" class="btn btn-main style-small">
                                    <span>
                                        <span>Subscribe</span>
                                    </span>
                                </button>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget_instagram ps-xl-5">
                        ...
                        <div class="widget widget_contact">
                            <ul>
                                <li><img src="assets/img/footer/1.png" alt="img"></li>
                                <li><img src="assets/img/footer/2.png" alt="img"></li>
                                <li><img src="assets/img/footer/3.png" alt="img"></li>
                                <li><img src="assets/img/footer/4.png" alt="img"></li>
                                <li><img src="assets/img/footer/5.png" alt="img"></li>
                                <li><img src="assets/img/footer/6.png" alt="img"></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p>© 2024 By DSConquer, All Rights Reserved</p>
                    </div>
